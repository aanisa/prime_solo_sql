...
VALUES ('nina', 'rochester', 12, 13, 350890.78);
...
SELECT * FROM syntax_practice WHERE transactions_completed < 5
AND (city ILIKE 'Miami' OR city ILIKE 'Phoenix');
